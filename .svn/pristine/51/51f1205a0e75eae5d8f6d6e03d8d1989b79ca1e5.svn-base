	...
	n={isUrl:function(e){
		...
		loadContent:function(e,t){
			...
			addPrefix:function(e){
				var t=e.attr("id"),
				i=e.attr("class");
				"string"==typeof t&&""!==t&&e.attr("id",
					t.replace(/([A-Za-z0-9_.\-]+)/g,"sidr-id-$1")),
				...
				execute:function(n,s,a){
					...
					if("open"===n||"toggle"===n&&!c.is(":visible")){
						...
						if(i!==!1)return o.close(i,function(){
							...
							t=!0,
							"left"===h?(r={left:p+"px"},
								d={left:"0px"}):(r={right:p+"px"},
								d={right:"0px"}),
								u.is("body")&&(l=f.scrollTop(),
									f.css("overflow-x","hidden").scrollTop(l)),
									m?u.addClass("sidr-animating").css({width:u.width(),
										position:"absolute"}).animate(r,g,function(){
											e(this).addClass(x)}):setTimeout(function(){
												e(this).addClass(x)},g),
											...
											v()}else{if(!c.is(":visible")||t)return;t=!0,
											"left"===h?(r={left:0},
